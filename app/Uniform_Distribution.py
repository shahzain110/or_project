...
class Bank_Simulation():
    ...
    def gen_service_time_teller1(self):
        # service = input("Enter Service Time of Server 1 : ")
    ...
    def gen_service_time_teller2(self):        
        # arrival2 = input("Enter Service Time Server 2 : ")                        #function to generate service time for teller 1 using inverse trnasform
