...
class Bank_Simulation():
    ...
    def gen_int_arr(self):                                             
        return np.random.normal(loc=0.5, scale=1.0, size=None) * 3
    
    def gen_service_time_teller1(self):                                
        return np.random.normal(loc=0.5, scale=1.0, size=None) *1.2
    
    def gen_service_time_teller2(self):                                
        return np.random.normal(loc=0.5, scale=1.0, size=None) *1.5
